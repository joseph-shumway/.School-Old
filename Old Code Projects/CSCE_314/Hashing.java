        ...
        try {
            ...
            for (Word word : wordList) {
                if (word.getCountPT() == word.getCountYT()) {
                    String output = new String(word.getValue() + "\t\t" + word.getCountPT() + "\n");
        ...
        try {
            ...
            for (Word word : wordList) {
                if (word.getCountPT() != word.getCountYT()) {
                    ...
                    if (word.getCountPT() > word.getCountYT()) {
                        outNum.append("+" + String.valueOf(Math.abs(word.getCountYT() - word.getCountPT())) + " PT");
                        
                    }
                    if (word.getCountYT() > word.getCountPT()) {
                        outNum.append("+" + String.valueOf(Math.abs(word.getCountYT() - word.getCountPT())) + " YT");
                    }
                    ...
                    String output = new String(word.getValue() + "\t\t" + outNum + "\n");
                    outfile.write(output);
    ...
    public void writeEqualHelper(BSTNode r, PrintWriter out) {
        if (r != null) {
            ...
            if (r.getData().getCountPT() == r.getData().getCountYT()) {
                ...
                String output = new String(r.getData().getValue() + "\t\t" + r.getData().getCountPT() + "\n");
                out.write(output);
            }
    ...
    public void writeDifferenceHelper(BSTNode r, PrintWriter out) {
        ...
        if (r != null) {
            ...
            if (r.getData().getCountPT() != r.getData().getCountYT()) {
                ...
                String output = new String(r.getData().getValue() + "\t\t" + outNum + "\n");
                out.write(output);
