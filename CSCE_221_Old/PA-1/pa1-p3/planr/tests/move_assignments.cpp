...
TEST(COLLECTION, MOVE_ASSIGNMENTS)
{
    {
        ...
        Stress_ball *arr1 = &(c1[0]);
        {
            ...
            {
                cout << "Fail: What happens with memory locations of objects when a move assignment is used. Are they same or different?" << endl;
                ASSERT_TRUE(false);
            }
        }
    ...
    }
    {
        ...
        cout << "Number of Stress_balls successfully inserted: " << c1.total_items() << endl;
        {
            ...
            {
                cout << "Fail: Should the object that is passed to the assignment be empty after assignment's operation is completed?" << endl;
                ASSERT_TRUE(false);
            }
        }
