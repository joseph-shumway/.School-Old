...
{
    {
        ...
        cout << "Expected number of Stress_balls: " << 9 << endl;
        ASSERT_EQ(cir.total_items(), 9);
    ...
    }
    {
        ...
        cout << "Expected number of Jeans: " << 9 << endl;
        ASSERT_EQ(cirj.total_items(), 9);
