...
TEST(COLLECTION, COPY_ASSIGNMENTS)
{
    {
        {
            ...
            Jeans *arr5 = &(c5[0]);
            {
                ...
                if (arr5 == &(c6[0]))
                {
                    cout << "Fail: What happens with memory locations of objects when a copy assignment is used. Are they same or different?" << endl;
