...
int main () {
	...
	// open command file
	MyString filename("TEST: 123");


	//MyString filename("Hello"); // MyString: default constructor

	// filename += " World";
	// cout << filename << endl;

	// int x = filename.find("Wordl");
	// cout << "Found Worl at: " << x << endl << endl;
