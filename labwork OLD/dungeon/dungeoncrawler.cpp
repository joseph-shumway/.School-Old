...
int main() {
    ...
    // printMap(testMap, testMaxRow, testMaxCol, "Test Before Resizing: ");
    // char** testMap2 = resizeMap(testMap, testMaxRow, testMaxCol);
    // printMap(testMap2, testMaxRow, testMaxCol, "Test After Resizing: ");    
    // exit(0);
